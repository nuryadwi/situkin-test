		  ...
		  <div class="card-body">
			  <?php
                   ...
                   ?>
                     ...
                     <a href="<?php echo base_url()?>cetaklaporanbulanan/<?=$bln."/".$thn?>" class="btn btn-success btn-sm" data-toggles="tooltip" title="Cetak Laporan" target="_blank"><i class="fa fa-print"></i></a>
                    </div>
			  <table id="tables1" class="table table-bordered table-striped table-responsive" cellspacing="0" width="100%">
				  <thead>
                        <tr>
                          <th width="2%">No.</th>
                          <th width="20%">Kegiatan</th>
                          <th width="5%">Volume</th>
						  <th width="15%">Pemberi Tugas</th>
